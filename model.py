    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            ...
            for idx in xrange(0, self.train_size, self.batch_size):
                batch_shapes, _ = self.next_batch(self.batch_size, 'train')  # THIS IS TRAINING
                ...
                for _ in range(d_iters):
                    ...
                    _, summary_str = self.sess.run([d_optim, self.d_sum],
                        feed_dict={self.shape_pair: batch_shapes})
                ...
                errD = self.d_loss.eval({self.shape_pair: batch_shapes})
                errG = self.g_loss.eval({self.shape_pair: batch_shapes})
